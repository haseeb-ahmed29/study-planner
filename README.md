...
A lightweight planning application for organizing study tasks and maintaining a consistent learning routine.

## Purpose

This repository was created as a practical project to explore the design and implementation of **Study Planner**. It can be used as a learning reference, a starting point for further development, or a demonstration of the related business workflow.
...
3. Add subjects or tasks, set the intended schedule, and use the planner to track study progress.
